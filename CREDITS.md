...
| Arcade far parallax | `public/textures/parallax/arcade_far.webp` | Provided by the project owner (original art) | Owned / original | 1920×1000 full-height skyline. Far parallax layer (opaque). |
...
| Arcade mid parallax | `public/textures/parallax/arcade_mid.webp` | Provided by the project owner (original art) | Owned / original | 1920×960 full-height storefronts. Mid parallax layer (opaque). |
| Arcade near parallax | `public/textures/parallax/arcade_near.webp` | Provided by the project owner (original art) | Owned / original | 1920×1024 full-height neon arcade street. Near parallax layer; scaled to fill the back-wall band. (Layers are opaque → the front/near one is what shows; transparent skies on far/mid would enable true see-through depth.) |
