...
| RushFan walk anim | `public/sprites/enemies/rushfan_walk.webp` | Provided by the project owner (original art) | Owned / original | 1254×1254 transparent 4×4 walk sheet (313px frames); baked to per-direction walk anims (~10fps). |
